...
| title_generator.py | `_ref/hermes-agent/agent/title_generator.py` | `python-backend/agent/titles/generator.py` + migration 024 | **DONE Phase-B P6 (backend)** (2026-04-20) — frontend display PENDING | `exec-06.md §4d` + `exec-transformersjs.md §3.5` |

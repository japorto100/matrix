...
function drawGlobeIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const r = size * 0.4;
	ctx.beginPath();
...
function drawGridIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.7;
	const h = size * 0.7;
...
function drawBracesIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.6;
	const h = size * 0.8;
	ctx.beginPath();
...
function drawDocOutline(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.7;
	const h = size * 0.85;
	const fold = size * 0.2;
	ctx.beginPath();
...
function drawNotionIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.5;
	const h = size * 0.6;
	const r = size * 0.08;
...
function drawSlidesIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.7;
	const h = size * 0.5;
	ctx.strokeRect(x - w / 2, y - h / 2, w, h);
...
function drawCloudIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const s = size * 0.35;
	ctx.beginPath();
...
function drawXIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const s = size * 0.3;
...
function drawPlayIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const r = size * 0.38;
	const w = r * 2.2;
	const h = r * 1.5;
	const cr = size * 0.08;
...
function drawImageIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.7;
	const h = size * 0.55;
	ctx.strokeRect(x - w / 2, y - h / 2, w, h);
	ctx.beginPath();
...
function drawTextNoteIcon(ctx: CanvasRenderingContext2D, x: number, y: number, size: number): void {
	const w = size * 0.55;
	const h = size * 0.6;
	const sp = h / 5;
	ctx.beginPath();

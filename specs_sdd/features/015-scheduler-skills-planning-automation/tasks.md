...
- [ ] T011 Verify prompt scanner blocks scheduled-task prompt injection on
  create and edit.
...
- [ ] T030 Verify skill DB seed and loader source modes.
- [ ] T031 Verify finder BM25/dense/RRF with expected-skill queries.
- [ ] T032 Verify disabled skills are filtered via current preference path.
...
- [ ] T036 Verify general always-loaded and task-specific retrieved split.
- [ ] T037 Verify `api_version` and assets survive DB roundtrip.
...
- [ ] T050 Verify plan skill triggers on DE and EN planning cues.
- [ ] T051 Verify plan skill response is read-only.
- [ ] T052 Verify execution waits for explicit user confirmation.

## PDDL

- [ ] T060 Choose or defer first PDDL pilot workflow.
- [ ] T061 Choose or defer solver stack.
- [ ] T062 Define refusal/repair loop before any execution integration.

...
- [ ] T005 Import exact old verify IDs into `live-verify.md` where still active.
- [ ] T006 Summarize built code state into `closeout.md`.

## Slice 0 — Foundation

- [ ] T010 Verify shell route and top nav in current `frontend_merger`.
- [ ] T011 Verify design tokens and layout are still aligned after merger.
- [ ] T012 Ensure old standalone `control-ui/` assumptions are translated to `frontend_merger`.
...
- [ ] T070 Verify SystemTab health for all configured services.
- [ ] T071 Verify AuditTab filters and export.
- [ ] T072 Verify SessionsTab list/detail/kill in dev mode.
- [ ] T073 Verify McpTab server/tool state.
- [ ] T074 Verify A2aTab delegation/AgentCard state.
...
- [ ] T084 Verify BFF catch-all routes preserve headers/body/query.
- [ ] T085 Verify no “coming soon” placeholders remain except documented deferred items.

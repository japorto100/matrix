...
- [x] T053 [done-static] Reuse Feature 024 progressive-disclosure search
  ...
  - 2026-04-30: agent runtime prompt preparation now reuses builtin tool
    ...
    already has BM25/dense traces.
  - 2026-04-30: `retrieve(...)` now accepts explicit metadata-only
    `source_candidates` and derives source candidates from vector/KG/lexical
    hits without copying full source bodies. Runtime events expose candidate
    ids/counts only.
